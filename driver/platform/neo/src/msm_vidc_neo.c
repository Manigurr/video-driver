...
static struct msm_platform_inst_capability instance_data_neo[] = {
	...
	{LSR_SESSION, DEC, H264|HEVC,
		V4L2_MPEG_MSM_VIDC_DISABLE, V4L2_MPEG_MSM_VIDC_ENABLE,
		1, V4L2_MPEG_MSM_VIDC_DISABLE,
		V4L2_CID_MPEG_VIDEO_DEC_LSR_SESSION,
	...
	{META_IN_OUT_PAIR_BUFFER_ID, DEC, CODECS_ALL,
		V4L2_MPEG_MSM_VIDC_DISABLE, V4L2_MPEG_MSM_VIDC_ENABLE,
		1, V4L2_MPEG_MSM_VIDC_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_IN_OUT_BUFFER_PAIR_ID,
		HFI_PROP_IN_OUT_PAIR_BUFID},

	{META_EVA_LSR_INFO, DEC, CODECS_ALL,
		V4L2_MPEG_MSM_VIDC_DISABLE, V4L2_MPEG_MSM_VIDC_ENABLE,
		1, V4L2_MPEG_MSM_VIDC_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_EVA_LSR_INFO,
		HFI_PROP_EVA_LSR_METADATA},

	{META_LSR_TIMER_STATS, DEC, CODECS_ALL,
		V4L2_MPEG_MSM_VIDC_DISABLE, V4L2_MPEG_MSM_VIDC_ENABLE,
		1, V4L2_MPEG_MSM_VIDC_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_LSR_TIMER_STATS,
		HFI_PROP_GLOBAL_TIMER_STATS},

	{META_NO_INPUT_INFO, DEC, CODECS_ALL,
		V4L2_MPEG_MSM_VIDC_DISABLE, V4L2_MPEG_MSM_VIDC_ENABLE,
		1, V4L2_MPEG_MSM_VIDC_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_NO_INPUT_INFO,
		HFI_PROP_NO_INPUT},
