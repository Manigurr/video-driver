...
static bool is_meta_ctrl(u32 id)
{
	return (id == V4L2_CID_MPEG_VIDC_METADATA_LTR_MARK_USE_DETAILS ||
		...
		id == V4L2_CID_MPEG_VIDC_METADATA_IN_OUT_BUFFER_PAIR_ID ||
		id == V4L2_CID_MPEG_VIDC_METADATA_EVA_LSR_INFO ||
		id == V4L2_CID_MPEG_VIDC_METADATA_LSR_TIMER_STATS ||
		id == V4L2_CID_MPEG_VIDC_METADATA_NO_INPUT_INFO ||
